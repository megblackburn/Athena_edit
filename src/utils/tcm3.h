...
int cool_t[40];
double cool_coef[40];
double cool_index[40];
double cool_tef[40];


//double Cooling_townsend(double temp, double rho, double dt, double Lambda_fac);
//double Cooling_Lambda(double temp);
//double Cooling_tcool(double temp, double rho);

int Cooling_townsend(double temp, double rho, double dt, double Lambda_fac) {
  
    
    double g;
    g = par_getd("problem","gamma");
    nbins = 40;
    const_factor = 1.e-23*(g-1.0)*mu/(Kboltz*mue*muH);
...
double Cooling_tcool(double temp, double rho) {
    ...
    cool_coef[8] = 25.224636283348048;
    cool_coef[9]= 38.02107089248533;
    cool_coef[10] = 43.98219098299675;                                                                    cool_coef[11] = 41.277704007796586;
    cool_coef[12] = 41.95311185975414;
    cool_coef[13] = 45.260670345801;
    cool_coef[14] = 47.275626188961176;
    cool_coef[15] = 32.21420131907784;
